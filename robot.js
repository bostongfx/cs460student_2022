Robot = function(x, y, z) {
    ...
    this.left_upperarm.position.y = -4;
    this.left_upperarm.position.x = 4;
    this.left_lowerarm = bones[ 2 ];
    this.left_lowerarm.position.y = -19;
    this.left_lowerarm.position.x = 4;
    this.left_hand = bones[ 3 ];
    this.left_hand.position.x = 4;
    this.left_hand.position.y = -4;
    ...
    this.right_upperarm.position.y = -4;
    this.right_upperarm.position.x = -4;
    this.right_lowerarm = bones[ 2 ];
    this.right_lowerarm.position.y = -19;
    this.right_lowerarm.position.x = -4;
    this.right_hand = bones[ 3 ];
    this.right_hand.position.x = -4;
    this.right_hand.position.y = -4;
    ...
    this.left_upperleg.position.y = -4;
    this.left_upperleg.position.x = 4;
    this.left_lowerleg = bones[ 2 ];
    this.left_lowerleg.position.y = -19;
    this.left_lowerleg.position.x = 4;
    this.left_foot = bones[ 3 ];
    this.left_foot.position.x = 4;
    this.left_foot.position.y = -4;
    ...
    this.right_upperleg.position.y = -4;
    this.right_upperleg.position.x = -4;
    this.right_lowerleg = bones[ 2 ];
    this.right_lowerleg.position.y = -19;
    this.right_lowerleg.position.x = -4;
    this.right_foot = bones[ 3 ];
    this.right_foot.position.x = -4;
    this.right_foot.position.y = -4;
