  ...
  lower_right_arm() {
	...
	onAnimate() {
      ...
      quat = new THREE.Quaternion(0, 0, 0, 1);
			...
			quat = new THREE.Quaternion(0, 0, 0, 1);
			this.leftUpperArm.quaternion.slerp(quat, 0.55);
			this.rightUpperArm.quaternion.slerp(quat, 0.75);
			this.rightUpperLeg.quaternion.slerp(quat, 0.105);
			this.leftUpperLeg.quaternion.slerp(quat, 0.205);
