Robot = function(x, y, z) {
  ...
  // bones is 4 element array
  // element 0 is anchor point
  // element 1 is the upper arm
  // element 2 is the lower arm
  // element 3 is the hand
...
//
// LEFT UPPER LEG, LOWER LEG, AND LEFT FOOT
//
var fromhelper = HELPER.cylinderSkeletonMesh(3, 5, 'blue')
  var geometry = fromhelper[0];
  var material = fromhelper[1];
  ...
  // bones is 4 element array
  // element 0 is anchor point
  // element 1 is the upper leg
  // element 2 is the lower leg
  // element 3 is the foot
