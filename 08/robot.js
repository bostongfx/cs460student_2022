Robot = function (x, y, z) {
    ...
    this.left_upperarm.position.y = -15;
    ...
    this.right_lowerarm.position.x = -15;
    this.right_lowerarm.position.y = 10;

    this.right_hand = bones[3];
    this.right_hand.position.x = 10;
    ...
    this.left_upperleg.position.y = -15;
...
Robot.prototype.onStep = function () {
    ...
    if (this.root.position.z > 490 || this.root.position.z < -400) {
        this.root.rotateY(Math.PI / 2);

    } else if (this.root.position.x > 490 || this.root.position.x < -400) {
        this.root.rotateY(Math.PI / 2);
    }
