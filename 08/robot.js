Robot = function(x, y, z) {
    ...
    head_g = new THREE.SphereBufferGeometry( 15, 12, 16);
    var head_texture =  new THREE.TextureLoader().load( 'face.jpg' );
    head_m = new THREE.MeshStandardMaterial({
    map: head_texture });
    this.sphere = new THREE.Mesh( head_g, head_m);
    ...
    this.neck.add(this.sphere);
  
    this.left_upperarm = bones[ 1 ];
    this.left_upperarm.position.x = 6;
    this.left_upperarm.position.y = -6;
  
    this.left_lowerarm = bones[ 2 ];
    this.left_lowerarm.position.x = 6;
    this.left_lowerarm.position.y = -16;
  
    this.left_hand = bones[ 3 ];
    this.left_hand.position.x = 6;
    this.left_hand.position.y = -6;
    ...
    // right arm, left leg, right leg
      ...
      var fromhelper = HELPER.cylinderSkeletonMesh(3, 5, 'violet');
      var geometry = fromhelper[0];
      var material = fromhelper[1];
      var bones = fromhelper[2];
      ...
      this.right_upperarm.position.x = -6;
      this.right_upperarm.position.y = -6;
  
      this.right_lowerarm = bones[2];
      this.right_lowerarm.position.x = -6;
      this.right_lowerarm.position.y = -16;
  
      this.right_hand = bones[3];
      this.right_hand.position.x = -6;
      this.right_hand.position.y = -6;
      ...
      this.left_upperleg.position.x = 6;
      this.left_upperleg.position.y = -6;
  
      this.left_lowerleg = bones[ 2 ];
      this.left_lowerleg.position.x = 6;
      this.left_lowerleg.position.y = -16;
  
      this.left_feet = bones[3];
      this.left_feet.position.x = 6;
      this.left_feet.position.y = -6;
      ...
      this.right_upperleg.position.x = -6;
      this.right_upperleg.position.y = -6;
  
      this.right_lowerleg = bones[2];
      this.right_lowerleg.position.x = -6;
      this.right_lowerleg.position.y = -16;
  
      this.right_feet = bones[3];
      this.right_feet.position.x = -6;
      this.right_feet.position.y = -6;
