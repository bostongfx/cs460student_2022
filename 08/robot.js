...
Robot = function Robot(x, y, z) {
	...
	// head, neck, and torso
	var body = addLimb('blue');
	this.root = body.bones[0];
	this.root.position.set(x, y, z);

	this.head = body.bones[1];

	var headTexture = new THREE.TextureLoader().load('hair.png');
	var headMesh = new THREE.MeshPhongMaterial({ map: headTexture });
	var headGeometry = new THREE.SphereBufferGeometry(15, 15, 15);
