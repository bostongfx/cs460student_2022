	...
	initMouseHandler(){
    	...
    	function raycast(e){
			...
			if (intersects.length>0){
				...
				console.log(pt);
				self.parasites[0].newPath(pt, true);
			}	
		}
    }

    load(){
        const loader = new GLTFLoader( ).setPath(`${this.game.assetsPath}fbx/`);
		...
		loader.load(
			...
			xhr => {
				...
				this.loadingBar.update( 'parasite', xhr.loaded, xhr.total );
